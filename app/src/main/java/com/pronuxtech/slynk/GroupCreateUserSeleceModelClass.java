...
public class GroupCreateUserSeleceModelClass {
    ...
    public GroupCreateUserSeleceModelClass() {

    }

    public GroupCreateUserSeleceModelClass(String uid, String profile_img, String first_name, String last_name, String email,
                                           String lower_name, String username, String phone, String password,
                                           String university_name, String current_course, String course_level,
                                           String graduation_year, String gender, String date_of_birth,
                                           int block, int online, Boolean isSelect) {
        this.uid = uid;
